...
class PatrolNode(Node):
    ...
    def _build_waypoints(self):
        ...
        p1 = make_pose(self, 0.057892873925732814, -0.08616179135585011, yaw=0.0)     # 시작 위치 - 정면
        p2 = make_pose(self, 0.3015711162082899, 1.0524194853069477, yaw=-1.57)       # 왼쪽
        p3 = make_pose(self, 0.7388827924517766, 1.100238274595851, yaw=1.57)         # 오른쪽
        p4 = make_pose(self, 0.9560184037170589, 0.37284989507904914, yaw=-1.57)      # 왼쪽
        p5 = make_pose(self, 1.1490053920419023, 1.2067245102341437, yaw=1.57)        # 오른쪽
        p6 = make_pose(self, 1.3698260820012045, 0.28971707075870173, yaw=-1.57)      # 왼쪽
        p7 = make_pose(self, 1.6042469642045845, 1.141071939198554, yaw=1.57)         # 오른쪽
        p8 = make_pose(self, 1.841999775665267, 0.1793767379122703, yaw=-1.57)        # 왼쪽
        p9 = make_pose(self, 2.075310092838169, 0.9759673713284526, yaw=1.57)         # 오른쪽
